...
- ADR-0008: watch finding-lifecycle model (TTY presentation superseded by ADR-0014)
...
- ADR-0013: ratatui + crossterm presentation stack
- ADR-0014: watch TTY is a findings TUI; lifecycle model unchanged
